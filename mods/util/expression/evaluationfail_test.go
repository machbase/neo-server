...
const INVALID_MODIFIER_TYPES = "cannot be used with the modifier"
const INVALID_COMPARATOR_TYPES = "cannot be used with the comparator"
const INVALID_LOGICALOP_TYPES = "cannot be used with the logical operator"
const INVALID_TERNARY_TYPES = "cannot be used with the ternary operator"
const ABSENT_PARAMETER = "no parameter"
const INVALID_REGEX = "unable to compile regexp pattern"
const INVALID_PARAMETER_CALL = "No method or field"
const TOO_FEW_ARGS = "too few arguments to parameter call"
const TOO_MANY_ARGS = "too many arguments to parameter call"
const MISMATCHED_PARAMETERS = "Argument type conversion failed"
