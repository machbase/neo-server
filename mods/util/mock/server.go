...
func (mock *DatabaseServerMock) Explain(sqlText string, full bool) (string, error) {
...
func (mock *DatabaseServerMock) GetServicePorts(service string) ([]*spi.ServicePort, error) {
	if mock.GetServicePortsFunc == nil {
		panic("DatabaseServerMock.GetServicePortsFunc: method is nil but DatabaseServer.GetServicePorts was just called")
	}
	callInfo := struct {
		Service string
	}{
...
// Check the length with:
//
//	len(mockedDatabaseServer.GetServicePortsCalls())
func (mock *DatabaseServerMock) GetServicePortsCalls() []struct {
	Service string
} {
	var calls []struct {
		Service string
...
func (mock *DatabaseServerMock) PrepareQuery(sqlText string) (spi.Rows, error) {
	if mock.PrepareQueryFunc == nil {
		panic("DatabaseServerMock.PrepareQueryFunc: method is nil but DatabaseServer.PrepareQuery was just called")
	}
	callInfo := struct {
		SqlText string
	}{
...
// Check the length with:
//
//	len(mockedDatabaseServer.PrepareQueryCalls())
func (mock *DatabaseServerMock) PrepareQueryCalls() []struct {
	SqlText string
} {
	var calls []struct {
		SqlText string
