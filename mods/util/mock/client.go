...
func (mock *DatabaseClientMock) PrepareQuery(sqlText string) (spi.Rows, error) {
	if mock.PrepareQueryFunc == nil {
		panic("DatabaseClientMock.PrepareQueryFunc: method is nil but DatabaseClient.PrepareQuery was just called")
	}
	callInfo := struct {
		SqlText string
	}{
...
// Check the length with:
//
//	len(mockedDatabaseClient.PrepareQueryCalls())
func (mock *DatabaseClientMock) PrepareQueryCalls() []struct {
	SqlText string
} {
	var calls []struct {
		SqlText string
