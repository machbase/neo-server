...
func main() {
	...
	if genDefs {
		generatesDefs(resultSets, resultImports)
	} else {
...
func generatesDefs(sets map[string]*SetX, imports map[string]*ImportX) {
	header := []string{
		`//go:generate go run ../generate.go defs`,
		``,
		`package defs`,
		``,
		`// Code generated by go generate; DO NOT EDIT.`,
	...
	file, err := os.Create("./defs.gen.go")
	if err != nil {
		panic(err)
	}
	file.Write(content)
