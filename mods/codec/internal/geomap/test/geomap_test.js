...
var obj0 = L.marker([37.49785,127.027756], defaultPointStyle).addTo(map);
var obj1 = L.circleMarker([37.503058,127.018666], defaultPointStyle).addTo(map);
var obj2 = L.point([37.496727,127.026612], defaultPointStyle).addTo(map);
})(WejMYXCGcYNL);