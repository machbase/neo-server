...
define DEF {
    ...
    MQTT_SOCK         = flag("--mqtt-sock", "${tempDir()}/machbase-neo-mqtt-${flag("--mqtt-port", 5653)}.sock")
    HTTP_PORT         = flag("--http-port", "5654")
    HTTP_SOCK         = flag("--http-sock", "${tempDir()}/machbase-neo-http-${flag("--http-port", 5654)}.sock")
    GRPC_PORT         = flag("--grpc-port", "5655")
    GRPC_SOCK         = flag("--grpc-sock", "${tempDir()}/machbase-neo-grpc-${flag("--grpc-port", 5655)}.sock")
