	...
	tests := []TqlTestCase{
		{
			...
			ExpectCSV: []string{
				...
				"MACHBASEDB,SYS,LOG_DATA,13,Log,",
				"MACHBASEDB,SYS,TAG_DATA,6,Tag,",
				"MACHBASEDB,SYS,TAG_SIMPLE,12,Tag,",
				"\n",
			},
		},
		{
			...
			ExpectCSV: []string{
				...
				"9,MACHBASEDB,SYS,_TAG_SIMPLE_META,_ID,__PK_IDX__TAG_SIMPLE_META_1,REDBLACK,UNCOMPRESS,0,100000,EQUAL",
				"10,MACHBASEDB,SYS,_TAG_SIMPLE_META,NAME,_TAG_SIMPLE_META_NAME,REDBLACK,UNCOMPRESS,0,100000,EQUAL",
				"\n",
			},
		},
		{
