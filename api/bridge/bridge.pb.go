...
func (x *ExecRequest) GetSqlExec() *SqlRequest {
	if x != nil {
		if x, ok := x.Command.(*ExecRequest_SqlExec); ok {
			return x.SqlExec
		}
	}
	return nil
...
func (x *ExecRequest) GetSqlQuery() *SqlRequest {
	if x != nil {
		if x, ok := x.Command.(*ExecRequest_SqlQuery); ok {
			return x.SqlQuery
		}
	}
	return nil
...
func (x *ExecRequest) GetInvoke() *InvokeRequest {
	if x != nil {
		if x, ok := x.Command.(*ExecRequest_Invoke); ok {
			return x.Invoke
		}
	}
	return nil
...
func (x *ExecResponse) GetResult() isExecResponse_Result {
	if x != nil {
		return x.Result
	}
	return nil
...
func (x *ExecResponse) GetSqlExecResult() *SqlExecResult {
	if x != nil {
		if x, ok := x.Result.(*ExecResponse_SqlExecResult); ok {
...
func (x *ExecResponse) GetSqlQueryResult() *SqlQueryResult {
	if x != nil {
		if x, ok := x.Result.(*ExecResponse_SqlQueryResult); ok {
...
func (x *ExecResponse) GetInvokeResult() *InvokeResult {
	if x != nil {
		if x, ok := x.Result.(*ExecResponse_InvokeResult); ok {
...
func (x *Datum) GetValue() isDatum_Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *Datum) GetVInt32() int32 {
	if x != nil {
		if x, ok := x.Value.(*Datum_VInt32); ok {
			return x.VInt32
		}
	}
	return 0
...
func (x *Datum) GetVUint32() uint32 {
	if x != nil {
		if x, ok := x.Value.(*Datum_VUint32); ok {
			return x.VUint32
		}
	}
	return 0
...
func (x *Datum) GetVInt64() int64 {
	if x != nil {
		if x, ok := x.Value.(*Datum_VInt64); ok {
			return x.VInt64
		}
	}
	return 0
...
func (x *Datum) GetVUint64() uint64 {
	if x != nil {
		if x, ok := x.Value.(*Datum_VUint64); ok {
			return x.VUint64
		}
	}
	return 0
...
func (x *Datum) GetVFloat() float32 {
	if x != nil {
		if x, ok := x.Value.(*Datum_VFloat); ok {
			return x.VFloat
		}
	}
	return 0
...
func (x *Datum) GetVDouble() float64 {
	if x != nil {
		if x, ok := x.Value.(*Datum_VDouble); ok {
			return x.VDouble
		}
	}
	return 0
...
func (x *Datum) GetVString() string {
	if x != nil {
		if x, ok := x.Value.(*Datum_VString); ok {
			return x.VString
		}
	}
	return ""
...
func (x *Datum) GetVBool() bool {
	if x != nil {
		if x, ok := x.Value.(*Datum_VBool); ok {
			return x.VBool
		}
	}
	return false
...
func (x *Datum) GetVBytes() []byte {
	if x != nil {
		if x, ok := x.Value.(*Datum_VBytes); ok {
			return x.VBytes
		}
	}
	return nil
...
func (x *Datum) GetVTime() int64 {
	if x != nil {
		if x, ok := x.Value.(*Datum_VTime); ok {
			return x.VTime
		}
	}
	return 0
...
func (x *Datum) GetVNull() bool {
	if x != nil {
		if x, ok := x.Value.(*Datum_VNull); ok {
			return x.VNull
		}
	}
	return false
...
const file_bridge_proto_rawDesc = "" +
	"\n" +
	"\fbridge.proto\x12\x06bridge\"\x13\n" +
	"\x11ListBridgeRequest\"\x88\x01\n" +
	"\x12ListBridgeResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x16\n" +
	"\x06reason\x18\x02 \x01(\tR\x06reason\x12\x16\n" +
	"\x06elapse\x18\x03 \x01(\tR\x06elapse\x12(\n" +
	"\abridges\x18\x04 \x03(\v2\x0e.bridge.BridgeR\abridges\"D\n" +
	"\x06Bridge\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\x12\x12\n" +
	"\x04path\x18\x03 \x01(\tR\x04path\"N\n" +
	"\x10AddBridgeRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\x12\x12\n" +
	"\x04path\x18\x03 \x01(\tR\x04path\"]\n" +
	"\x11AddBridgeResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x16\n" +
	"\x06reason\x18\x02 \x01(\tR\x06reason\x12\x16\n" +
	"\x06elapse\x18\x03 \x01(\tR\x06elapse\"&\n" +
	"\x10GetBridgeRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"\x85\x01\n" +
	"\x11GetBridgeResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x16\n" +
	"\x06reason\x18\x02 \x01(\tR\x06reason\x12\x16\n" +
	"\x06elapse\x18\x03 \x01(\tR\x06elapse\x12&\n" +
	"\x06bridge\x18\x04 \x01(\v2\x0e.bridge.BridgeR\x06bridge\"&\n" +
	"\x10DelBridgeRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"]\n" +
	"\x11DelBridgeResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x16\n" +
	"\x06reason\x18\x02 \x01(\tR\x06reason\x12\x16\n" +
	"\x06elapse\x18\x03 \x01(\tR\x06elapse\"'\n" +
	"\x11TestBridgeRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"^\n" +
	"\x12TestBridgeResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x16\n" +
	"\x06reason\x18\x02 \x01(\tR\x06reason\x12\x16\n" +
	"\x06elapse\x18\x03 \x01(\tR\x06elapse\"(\n" +
	"\x12StatsBridgeRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"\xff\x01\n" +
	"\x13StatsBridgeResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x16\n" +
	"\x06reason\x18\x02 \x01(\tR\x06reason\x12\x16\n" +
	"\x06elapse\x18\x03 \x01(\tR\x06elapse\x12\x16\n" +
	"\x06inMsgs\x18\x04 \x01(\x04R\x06inMsgs\x12\x18\n" +
	"\ainBytes\x18\x05 \x01(\x04R\ainBytes\x12\x18\n" +
	"\aoutMsgs\x18\x06 \x01(\x04R\aoutMsgs\x12\x1a\n" +
	"\boutBytes\x18\a \x01(\x04R\boutBytes\x12\x1a\n" +
	"\binserted\x18\b \x01(\x04R\binserted\x12\x1a\n" +
	"\bappended\x18\t \x01(\x04R\bappended\"\xbf\x01\n" +
	"\vExecRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12.\n" +
	"\asqlExec\x18\x02 \x01(\v2\x12.bridge.SqlRequestH\x00R\asqlExec\x120\n" +
	"\bsqlQuery\x18\x03 \x01(\v2\x12.bridge.SqlRequestH\x00R\bsqlQuery\x12/\n" +
	"\x06invoke\x18\x04 \x01(\v2\x15.bridge.InvokeRequestH\x00R\x06invokeB\t\n" +
	"\acommand\"\x9f\x02\n" +
	"\fExecResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x16\n" +
	"\x06reason\x18\x02 \x01(\tR\x06reason\x12\x16\n" +
	"\x06elapse\x18\x03 \x01(\tR\x06elapse\x12=\n" +
	"\rsqlExecResult\x18\x04 \x01(\v2\x15.bridge.SqlExecResultH\x00R\rsqlExecResult\x12@\n" +
	"\x0esqlQueryResult\x18\x05 \x01(\v2\x16.bridge.SqlQueryResultH\x00R\x0esqlQueryResult\x12:\n" +
	"\finvokeResult\x18\x06 \x01(\v2\x14.bridge.InvokeResultH\x00R\finvokeResultB\b\n" +
	"\x06result\"M\n" +
	"\n" +
	"SqlRequest\x12\x18\n" +
	"\asqlText\x18\x01 \x01(\tR\asqlText\x12%\n" +
	"\x06params\x18\x02 \x03(\v2\r.bridge.DatumR\x06params\"[\n" +
	"\rSqlExecResult\x12&\n" +
	"\x0elastInsertedId\x18\x01 \x01(\x03R\x0elastInsertedId\x12\"\n" +
	"\frowsAffected\x18\x02 \x01(\x03R\frowsAffected\"]\n" +
	"\x0eSqlQueryResult\x12\x16\n" +
	"\x06handle\x18\x01 \x01(\tR\x06handle\x123\n" +
	"\x06fields\x18\x04 \x03(\v2\x1b.bridge.SqlQueryResultFieldR\x06fields\"9\n" +
	"\rInvokeRequest\x12\x12\n" +
	"\x04args\x18\x01 \x03(\tR\x04args\x12\x14\n" +
	"\x05stdin\x18\x02 \x01(\fR\x05stdin\"Z\n" +
	"\fInvokeResult\x12\x1a\n" +
	"\bexitCode\x18\x01 \x01(\x05R\bexitCode\x12\x16\n" +
	"\x06stdout\x18\x02 \x01(\fR\x06stdout\x12\x16\n" +
	"\x06stderr\x18\x03 \x01(\fR\x06stderr\"i\n" +
	"\x13SqlQueryResultField\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\x12\x12\n" +
	"\x04size\x18\x03 \x01(\x05R\x04size\x12\x16\n" +
	"\x06length\x18\x04 \x01(\x05R\x06length\"\xac\x01\n" +
	"\x1bSqlQueryResultFetchResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x16\n" +
	"\x06reason\x18\x02 \x01(\tR\x06reason\x12\x16\n" +
	"\x06elapse\x18\x03 \x01(\tR\x06elapse\x12\x1c\n" +
	"\thasNoRows\x18\x04 \x01(\bR\thasNoRows\x12%\n" +
	"\x06values\x18\x05 \x03(\v2\r.bridge.DatumR\x06values\"\xd0\x02\n" +
	"\x05Datum\x12\x19\n" +
	...
	"\x05value\"g\n" +
	"\x1bSqlQueryResultCloseResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x16\n" +
	"\x06reason\x18\x02 \x01(\tR\x06reason\x12\x16\n" +
	"\x06elapse\x18\x03 \x01(\tR\x06elapse2\xb0\x03\n" +
	"\n" +
	"Management\x12E\n" +
	"\n" +
	"ListBridge\x12\x19.bridge.ListBridgeRequest\x1a\x1a.bridge.ListBridgeResponse\"\x00\x12B\n" +
	"\tAddBridge\x12\x18.bridge.AddBridgeRequest\x1a\x19.bridge.AddBridgeResponse\"\x00\x12B\n" +
	"\tGetBridge\x12\x18.bridge.GetBridgeRequest\x1a\x19.bridge.GetBridgeResponse\"\x00\x12B\n" +
	"\tDelBridge\x12\x18.bridge.DelBridgeRequest\x1a\x19.bridge.DelBridgeResponse\"\x00\x12E\n" +
	"\n" +
	"TestBridge\x12\x19.bridge.TestBridgeRequest\x1a\x1a.bridge.TestBridgeResponse\"\x00\x12H\n" +
	"\vStatsBridge\x12\x1a.bridge.StatsBridgeRequest\x1a\x1b.bridge.StatsBridgeResponse\"\x002\xea\x01\n" +
	"\aRuntime\x123\n" +
	"\x04Exec\x12\x13.bridge.ExecRequest\x1a\x14.bridge.ExecResponse\"\x00\x12T\n" +
	"\x13SqlQueryResultFetch\x12\x16.bridge.SqlQueryResult\x1a#.bridge.SqlQueryResultFetchResponse\"\x00\x12T\n" +
	"\x13SqlQueryResultClose\x12\x16.bridge.SqlQueryResult\x1a#.bridge.SqlQueryResultCloseResponse\"\x00B.Z,github.com/machbase/neo-server/v8/api/bridgeb\x06proto3"
