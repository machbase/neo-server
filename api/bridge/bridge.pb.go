...
func file_bridge_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_bridge_proto_msgTypes[11].Exporter = func(v any, i int) any {
			switch v := v.(*StatsBridgeRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_bridge_proto_msgTypes[12].Exporter = func(v any, i int) any {
			switch v := v.(*StatsBridgeResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_bridge_proto_msgTypes[19].Exporter = func(v any, i int) any {
		...
		file_bridge_proto_msgTypes[20].Exporter = func(v any, i int) any {
		...
		file_bridge_proto_msgTypes[21].Exporter = func(v any, i int) any {
		...
		file_bridge_proto_msgTypes[22].Exporter = func(v any, i int) any {
			switch v := v.(*Datum); i {
			case 0:
				return &v.state
			case 1:
		...
		file_bridge_proto_msgTypes[23].Exporter = func(v any, i int) any {
