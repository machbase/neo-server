...
func DashboardHandler() http.HandlerFunc {
	...
	dash.AddChart(metric.Chart{Title: "DB Pool Conn", MetricNames: []string{"sys:pool:open", "sys:pool:in_use", "sys:pool:idle"}, FieldNames: []string{"last"}})
	dash.AddChart(metric.Chart{Title: "DB Pool Wait", MetricNames: []string{"sys:pool:wait_duration"}, FieldNames: []string{"non_negative_diff"}})
	dash.AddChart(metric.Chart{Title: "DB Pool Closed", MetricNames: []string{"sys:pool:wait_count", "sys:pool:max_*_closed"}, FieldNames: []string{"non_negative_diff"}})
