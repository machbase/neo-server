...
class Server {
    constructor(requestListener = { network: 'tcp', address: '127.0.0.1:3000' }) {
        if (!requestListener.env) {
    ...
    staticFile(path, file) {
        this.raw.staticFile(path, file);
        return this;
    }
    loadHTMLFiles(...files) {
        this.raw.loadHTMLFiles(...files);
        return this;
    }
    loadHTMLGlob(pattern) {
        this.raw.loadHTMLGlob(pattern);
        return this;
    }
}
