...
func Module(rt *js.Runtime, module *js.Object) {
...
func new_log(rt *js.Runtime) func(call js.ConstructorCall) *js.Object {
...
func now(rt *js.Runtime) func(call js.FunctionCall) js.Value {
	return func(call js.FunctionCall) js.Value {
		return rt.ToValue(time.Now())
	}
}

func timeTime(rt *js.Runtime) func(call js.FunctionCall) js.Value {
	return func(call js.FunctionCall) js.Value {
...
func timeLocation(rt *js.Runtime) func(js.FunctionCall) js.Value {
	return func(call js.FunctionCall) js.Value {
		name := "UTC"
		if len(call.Arguments) > 0 {
			if err := rt.ExportTo(call.Arguments[0], &name); err != nil {
...
func parseTime(rt *js.Runtime) func(js.FunctionCall) js.Value {
	return func(call js.FunctionCall) js.Value {
		if len(call.Arguments) == 0 {
...
func statz(rt *js.Runtime) func(samplingInterval string, keyFilters ...string) js.Value {
